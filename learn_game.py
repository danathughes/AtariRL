...
environment, agent, eval_agent, counter, checkpoint = load_config('example.cfg', sess)
dqn_agent = agent.base_agent

# Create a Tensorboard monitor and populate with the desired summaries
tensorboard_monitor = TensorboardMonitor('./log/breakout/dqn/replay_memory_and_target_Q/', sess, counter)
